          ...
          return (
            ...
            t.each(["my", "at"], function () {
              ...
              1 === i.length &&
                ...
                (s[this] = [l.exec(i[0])[0], l.exec(i[1])[0]]);
            }),
            1 === y.length && (y[1] = y[0]),
            "right" === s.at[0]
              ? (g.left += d)
            ...
            this.each(function () {
              ...
              "right" === s.my[0]
                ? (D.left -= l)
                : "center" === s.my[0] && (D.left -= l / 2),
                "bottom" === s.my[1]
                  ? (D.top -= u)
                  : "center" === s.my[1] && (D.top -= u / 2),
                (D.left += I[0]),
                (D.top += I[1]),
                (a = { marginLeft: m, marginTop: k }),
                ...
                s.using &&
                  (r = function (t) {
                    ...
                    l > d && d > o(e + i) && (c.horizontal = "center"),
        ...
        (t.ui.position = {
          fit: {
            left: function (t, e) {
              ...
              e.collisionWidth > a
                ? h > 0 && 0 >= l
                  ? ((i = t.left + h + e.collisionWidth - a - o),
                    (t.left += h - i))
                  : (t.left =
                      l > 0 && 0 >= h
                        ? o
            ...
            top: function (t, e) {
              ...
              e.collisionHeight > a
                ? h > 0 && 0 >= l
                  ? ((i = t.top + h + e.collisionHeight - a - o),
                    (t.top += h - i))
                  : (t.top =
                      l > 0 && 0 >= h
                        ? o
          ...
          flip: {
            ...
            top: function (t, e) {
              var i,
                ...
                f = -2 * e.offset[1];
              0 > c
                ? (0 > (s = t.top + d + p + f + e.collisionHeight - r - a) ||
                    o(c) > s) &&
                  (t.top += d + p + f)
                : u > 0 &&
