...
!(function (e, t, n, r) {
  ...
  function s(e, t) {
    if ("object" == typeof e) for (var n in e) T(e, n) && s(n, e[n]);
    else {
  ...
  function l(e, t, r, o) {
    ...
    if (parseInt(r, 10))
      for (; r--; )
        ((l = a("div")).id = o ? o[r] : f + (r + 1)), c.appendChild(l);
    return (
  ...
  function A(e, t, n, i) {
    ...
    for (
      var u, c, A, m, h, v = ["modernizr", "tspan", "samp"];
      !z.style && v.length;

    )
      (u = !0), (z.modElem = a(v.shift())), (z.style = z.modElem.style);
  ...
  w._q.unshift(function () {
    ...
    (y.testStyles = l),
    w.addTest("customelements", "customElements" in t),
  ...
  w.addTest("postmessage", new Boolean("postMessage" in t)),
    w.addTest("postmessage.structuredclones", N),
  ...
  w.addTest("websockets", R),
    ...
    w.addTest("picture", "HTMLPictureElement" in t),
    ...
    w.addTest("srcset", "srcset" in a("img")),
        ...
        if (g.hasOwnProperty(a)) {
          ...
          for (
            ...
            1 === (s = e[i].split(".")).length
              ? (w[s[0]] = r)
              : ((w[s[0]] && (!w[s[0]] || w[s[0]] instanceof Boolean)) ||
